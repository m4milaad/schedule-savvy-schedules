-- Fix the student enrollments function to use proper profile IDs
...
DECLARE
    v_course RECORD;
    v_profile RECORD;
    v_profiles_cursor CURSOR FOR 
        SELECT id, full_name, ROW_NUMBER() OVER (ORDER BY id) as profile_number
        FROM profiles 
