  ...
  public: {
    Tables: {
      ...
      leave_applications: {
        ...
        Relationships: [
          {
            foreignKeyName: "leave_applications_applicant_id_fkey"
      ...
      notices: {
        ...
        Relationships: [
          {
            foreignKeyName: "notices_target_course_id_fkey"
          ...
          {
            foreignKeyName: "notices_target_dept_id_fkey"
    ...
    Enums: {
      app_role: "admin" | "department_admin" | "student" | "teacher"
    }
    CompositeTypes: {
      [_ in never]: never
    }
