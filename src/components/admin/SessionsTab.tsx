            ...
            <Dialog open={isAddDialogOpen} onOpenChange={setIsAddDialogOpen}>
              ...
              <DialogContent>
                ...
                <div className="space-y-4">
                  ...
                  <div className="flex gap-2">
                    <Button onClick={handleAddSession} className="flex-1">Add Session</Button>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Are you sure you want to delete "{session.session_name}"? This will also delete all associated exam schedules and data.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
