    ...
    <Card>
      ...
      <CardContent>
        <div className="space-y-2 max-h-60 overflow-y-auto">
          {schools.map((school) => (
            <div key={school.school_id} className="flex items-center justify-between p-3 border rounded-lg">
              <div>
                  ...
                  <AlertDialogContent>
                    <AlertDialogHeader>
                      ...
                      <AlertDialogDescription>
                        Are you sure you want to delete "{school.school_name}"? This will also delete all associated departments and their data.
                      </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
